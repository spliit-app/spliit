...
[![Deploy to PandaStack](https://dashboard.pandastack.io/deploy-button.svg)](https://dashboard.pandastack.io/deploy?repo=spliit-app/spliit&type=static&buildCmd=npm+run+build&outputDir=dist)

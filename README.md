[<img alt="Knots" height="60" src="https://github.com/spliit-app/spliit/blob/main/public/logo-with-text.png?raw=true" />](https://knot.app)

Knots is a free and open source alternative to Splitwise. You can either use the official instance at [Knot.app](https://knot.app), or deploy your own instance:
...
Join the discussion in [the Knots Discord server](https://discord.gg/YSyVXbwvSY).
...
Knots offers users to upload images (to an AWS S3 bucket) and attach them to expenses. To enable this feature:
